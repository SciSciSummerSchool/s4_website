...
Project is built on top of [Jekyll](http://jekyllrb.com/) - simple, announcement-aware, static site generator. Jekyll also happens to be the engine behind GitHub Pages, which means you can use Jekyll to host your website from GitHub’s servers for free. [Learn more about Jekyll](http://jekyllrb.com/).
